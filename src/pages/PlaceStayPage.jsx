  ...
  const sections = {
    ...
    Stay: (
      <>
        ...
        <p>  
        Prisen for to overnattingar med frukost er kr 2000 per person. Oppgjer for overnatting og frukost gjerast via oss og kan vippsast til Aslak. <br></br> Telefonnummer: 414 75 029
        </p>
